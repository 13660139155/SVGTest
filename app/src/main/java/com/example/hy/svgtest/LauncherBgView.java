...
public class LauncherBgView extends View {
    ...
    private static final String PATH = "pathData";
    ...
    private Handler mHandler = new Handler(Looper.getMainLooper()){
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case PARSER_SUCCESS:
                    Log.d(TAG, "解析SVG成功，mSvgWidth = " + mSvgWidth + ", mSvgHeight = " + mSvgHeight + ", mSvgRealSize = " + mSvgRealSize);
                    sendEmptyMessage(START_DRAW);
                    break;
                case PARSER_ERROR:
                    Log.d(TAG, "解析SVG错误，mSvgWidth = " + mSvgWidth + ", mSvgHeight = " + mSvgHeight + ", mSvgRealSize = " + mSvgRealSize);
                    break;
                case START_DRAW:
                    Log.d(TAG, "开始绘制");
    ...
    private class ParserThread extends Thread{
        ...
        public void run() {
            ...
            try {
                ...
                e.printStackTrace();
                Log.e(TAG, "打开DocumentBuilderFactory出错， e = " + e.getMessage());
    ...
    public class PathData {
        ...
        public PathData(android.graphics.Path pathData, int fillColor, int stokeColor, float stokeWidth) {
